...
{
    internal sealed class GetTasksByCaseQueryHandler : IQueryHandler<GetTasksByCaseQuery, IEnumerable<LegalTaskDto>>
    {
        private readonly ISqlConnectionFactory _sqlConnectionFactory;

        public GetTasksByCaseQueryHandler(ISqlConnectionFactory sqlConnectionFactory)
        {
            _sqlConnectionFactory = sqlConnectionFactory;
        }

        public async Task<Result<IEnumerable<LegalTaskDto>>> Handle(GetTasksByCaseQuery request, CancellationToken cancellationToken)
        {
            ...
            var tasks = await connection.QueryAsync<LegalTaskDto>(sql, new { CaseId = request.CaseId });
